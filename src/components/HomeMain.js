...
const HomeMain = () => (
    <div className='sidebyside'>
        <div className='swapfalse' style={{flexBasis: '60%', paddingLeft:'50px', paddingTop:'50px'}}>
            <img style={{
                        width: '300px',
                        height: '400px'
                    }} alt='nothing' src={man}/>
        ...
        <div style={{flexBasis: '50%',marginLeft:'60px', paddingLeft:'50px',paddingRight:'20px',paddingTop:'100px',margin:'10px'}}>
            ...
            <div style={{paddingTop:'25px',textAlign: 'right', paddingLeft: '50px'}} className="headerright">
        ...
        <div className='swaptrue' style={{flexBasis: '40%', paddingLeft:'50px', paddingTop:'50px'}}>
            <img style={{
                        width: '300px',
                        height: '400px'
                    }} alt='nothing' src={man}/>
