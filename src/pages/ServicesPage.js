    ...
    return(
        <div className="hero">
            ...
            <div className="service-nav-container">
             ...
             <div className={toggleState === 1? "service-nav-content-container-mod":"service-nav-content-container"}> 
                <div className="service-nav-container-container"><ul><li className="list">We take up projects in various business domains which needs analytical solutions.</li></ul></div>
                <div className="service-nav-container-container"><ul><li className="list">We undertake tasks on data analysis, model building and forecasting as part of customized solutions.</li></ul></div>
                <div className="service-nav-container-container"><ul><li className="list">We also provide evaluation and assessment on programs and processes.</li></ul></div>
            </div>
            ...
            <div className={toggleState === 3? "service-nav-content-container-mod":"service-nav-content-container"}> 
                <div className="service-nav-container-container"><ul>
